      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">Android Remote Control</h1>
            <p className="text-gray-600 dark:text-gray-300">登录以管理您的Android设备</p>
          </div>
